...
train_dir = "data/03_converted/synthetic_4_parts_from_irishman/multiple_train_datasets_10"
...
with open(os.path.join(output_dir, "train_text_multiple_train_datasets_10.txt"), "w") as f:
    f.write(train_text)

with open(os.path.join(output_dir, "valid_text_multiple_train_datasets_10.txt"), "w") as f:
    f.write(valid_text)
...
# Loaded 83890 texts from the train directory.
# Vocabulary size: 225
# Sample itos mapping: {0: 'd30', 1: 'd27', 2: 'o29', 3: 'o24', 4: 'o39'}
# Sample stoi mapping: {'d30': 0, 'd27': 1, 'o29': 2, 'o24': 3, 'o39': 4}
# train has 128,285,945 tokens
