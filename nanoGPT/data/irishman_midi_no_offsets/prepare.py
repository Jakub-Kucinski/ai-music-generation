...
validation_dir = "data/03_converted/irishman/validation_leadsheet/midi_texts_no_offsets"
train_dir = "data/03_converted/irishman/train_leadsheet/midi_texts_no_offsets"
...
with open("data/03_converted/music21_bach/train_text_no_offsets.txt", "r") as f:
    bach_train = f.read()
with open("data/03_converted/music21_bach/valid_text_no_offsets.txt", "r") as f:
    bach_valid = f.read()
