...
validation_dir = "data/03_converted/synthetic_4_parts_from_irishman/validation/midi_texts_no_same_key"
train_dir = "data/03_converted/synthetic_4_parts_from_irishman/train/midi_texts/midi_texts_no_same_key"
...
with open(os.path.join(output_dir, "train_text_no_same_key.txt"), "w") as f:
    f.write(train_text)

with open(os.path.join(output_dir, "valid_text_no_same_key.txt"), "w") as f:
    f.write(valid_text)
